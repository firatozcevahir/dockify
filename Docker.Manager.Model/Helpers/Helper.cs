...
namespace Docker.Manager.Model.Helpers
{
    public static class Helper
    {
        ...
        public static DockerHubResponse GetDockerHubResponse(Exception ex)
        {
            return new DockerHubResponse
            {
                Success = false,
        ...
        public static string SerialErrorMessage(Exception ex)
        {
            return ex.Message;
        }
    }
