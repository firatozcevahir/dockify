...
namespace Dockify.Model.Migrations
{
    ...
    [Migration("20210107075347_AppTemplateModelUpdate")]
    partial class AppTemplateModelUpdate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Dockify.Model.Entities.Company", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dockify.Model.Entities.CompanyDockerImage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dockify.Model.Entities.DockerAppTemplate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");

                    b.Property<bool>("AlwaysPullImage")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("Dockify.Model.Entities.DockerRegistry", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("Dockify.Model.Entities.ShellScript", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("ShellScripts");
                });

            modelBuilder.Entity("Dockify.Model.Entities.CompanyDockerImage", b =>
                {
                    b.HasOne("Dockify.Model.Entities.Company", "Companies")
                        .WithMany("CompanyDockerImages")
                        .HasForeignKey("CompanyId");

                    b.HasOne("Dockify.Model.Entities.DockerAppTemplate", "DockerImages")
                        .WithMany()
            ...
            modelBuilder.Entity("Dockify.Model.Entities.Company", b =>
                {
                    b.Navigation("CompanyDockerImages");
                });
